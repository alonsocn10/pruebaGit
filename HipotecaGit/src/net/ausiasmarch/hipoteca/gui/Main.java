...
public class Main extends javax.swing.JFrame {
    ...
    private void jButtonCalcularActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        double ingresosMensuales,diferencialReal;
        int edad;
        double euribor; double diferencial; double interesAnual; double cuotaMensual ; int anyos ;
        ...
        if (!Convert.isValidInt(jTextFieldDiferencial.getText())) {
            sb.append(" - Difernecial: Valor no valido.\n");
        }
        if (!Convert.isValidInt(jTextFieldImportePrestamo.getText())) {
            sb.append(" - ImportePrestamo: Valor no valido.\n");
        }
