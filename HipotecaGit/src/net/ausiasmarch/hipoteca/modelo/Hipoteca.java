   ...
   ***************************************************************************/
   ...
   // Metodo para reglas de validacion ......................................
    ...
    public boolean validate() {
       ...
       if (trabajador.equalsIgnoreCase("Cuenta Ajena") && (ingresosMensuales*30)/100 < cuotaMensual) {
        	sb.append(" - La edad debe ser mayor de 18 años");
        	
        }
        
        // 5: Si autonomo,el 20% del saldo debe ser mayor que la cuota mensual.
        if (trabajador.equalsIgnoreCase("Autonomo") && (ingresosMensuales*20)/100 < cuotaMensual()) {
        	sb.append(" - La edad debe ser mayor de 18 años");
        	
        }
        
        // 6: Si funcionario,el 40% del saldo debe ser mayor que la cuota mensual.
        if (trabajador.equalsIgnoreCase("Funcionario") && (ingresosMensuales*40)/100 < cuotaMensual()) {
        	sb.append(" - La edad debe ser mayor de 18 años");
        ...
        if (edad>=50) {
        	sb.append(" - Debe contratar el seguro de vida");
        ...
        // 10: Si es funcionario debe contratar al menos 1 producto.
        if (trabajador.equalsIgnoreCase("Funcionario") && (contratadoSeguroVida==false && contratadoNomina==false &&
         contratadoTarjeta== false && contratadoPension== false)  ){
        	sb.append(" - debe contratar al menos 1 producto.");
        ...
        // 11: Si no es funcionario debe contratar al menos 2 productos.
        int i=0;
        if ( ((trabajador.equalsIgnoreCase("Cuenta Ajena"))||(trabajador.equalsIgnoreCase("Autonomo"))) ) {
        	if(isContratadoNomina()==true) {
        		
        		i++;
        	}
        		if(isContratadoPension()==true) {
        		
        		i++;
        	}
        		if(isContratadoSeguroVida()==true) {
	
        			i++;
        		}
        		if(isContratadoTarjeta()==true) {
	
        			i++;
        		}
        		if(i < 2) {
        			sb.append(" - Si no es funcionario debe contratar al menos 2 productos");
   ...
   // Metodos pra calculos ..................................................
    ...
    public double interesAnual() {
    	double interesAnual;
    	interesAnual=euribor+diferencialReal();
    	return interesAnual;
    }
    double cuotaMensual;
    public double cuotaMensual() {
    	
    	cuotaMensual=(importePrestamo*(interesAnual()/12))/(100*(1- Math.pow(1 +(interesAnual()/1200), -(anyos*12))));
    	return cuotaMensual;
    }
